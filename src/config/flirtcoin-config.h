/* src/config/flirtcoin-config.h.  Generated from flirtcoin-config.h.in by configure.  */
/* src/config/flirtcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FLIRTCOIN_CONFIG_H

#define FLIRTCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@flirt.life"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Flirtcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Flirtcoin Core 0.9.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "flirtcoin"
