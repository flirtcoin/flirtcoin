...
#ifndef FLIRTCOIN_RPCPROTOCOL_H
#define FLIRTCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Flirtcoin is not connected
