...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CFlirtcoinAddress demoAddress = CFlirtcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CFlirtcoinAddress setaccountDemoAddress = CFlirtcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CFlirtcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFlirtcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
