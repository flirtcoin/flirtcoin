...
#ifndef FLIRTCOIN_QT_FLIRTCOINUNITS_H
#define FLIRTCOIN_QT_FLIRTCOINUNITS_H
...
/** Flirtcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FlirtcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FlirtcoinUnits(QObject *parent);

    /** Flirtcoin units.
      @note Source: https://en.flirtcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FLIRT,
...
typedef FlirtcoinUnits::Unit FlirtcoinUnit;

#endif // FLIRTCOIN_QT_FLIRTCOINUNITS_H
