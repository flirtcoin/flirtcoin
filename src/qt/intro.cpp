...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/flirtcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Flirtcoin Core"),
     ...
     * override -datadir in the flirtcoin.conf file in the default data directory
     * (to be consistent with flirtcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
