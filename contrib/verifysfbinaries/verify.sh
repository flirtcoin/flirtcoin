...
###   This script attempts to download the signature file SHA256SUMS.asc from flirt.life
...
WORKINGDIR="/tmp/flirtcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://flirt.life/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://flirt.life/bin/"
VERSIONPREFIX="flirtcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'flirtcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[flirtcoin-]<version>-[rc[0-9]] (example: flirtcoin-0.9.2-rc1)"
   echo "wget output:"
