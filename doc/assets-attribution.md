The following is a list of assets used in the flirtcoin source and their proper attribution.
...
* License: MIT
* Site: [https://flirtcointalk.org/index.php?topic=15276.0](https://flirtcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original flirtcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/flirtcoin.icns, src/qt/res/src/flirtcoin.svg,
	src/qt/res/src/flirtcoin.ico, src/qt/res/src/flirtcoin.png,
	src/qt/res/src/flirtcoin_testnet.png, docs/flirtcoin_logo_doxygen.png,
