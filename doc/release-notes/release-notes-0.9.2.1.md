Flirtcoin Core version 0.9.2.1 is now available from:

  https://flirt.life/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FLIRT to 0.01 FLIRT
...
- Fix "Start flirtcoin on system login"
