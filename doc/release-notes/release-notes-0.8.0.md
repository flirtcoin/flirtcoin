Flirtcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/flirtcoin/files/Flirtcoin/flirtcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Flirtcoin
...
New/changed settings (command-line or flirtcoin.conf file)
--------------------------------------------------------
