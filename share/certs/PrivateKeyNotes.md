...
unlocked to sign the Flirtcoin-Qt.app bundle.
...
allowing somebody to distribute a Flirtcoin-Qt.app or flirtcoin-qt-setup.exe with a valid
...
that the flirtcoin-qt.exe file inside the installer had not been tampered with.
